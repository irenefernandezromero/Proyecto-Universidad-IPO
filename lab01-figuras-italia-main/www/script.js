...
function ___dragEnd(e) {
  ...
  e.target.classList.remove("figura--arrastrando");  //Elimino el estilo de clase figura--arrastrando
}
...
function ___dragEnter(e) {
  ...
  e.target.classList.add("figura--sobrevolando");  //Añado el estilo de clase figura--sobrevolando
}
...
function ___modificaAspectoDelPatron(panelPatron) {
  ...
  panelPatron.classList.add("panel--completado");
}
